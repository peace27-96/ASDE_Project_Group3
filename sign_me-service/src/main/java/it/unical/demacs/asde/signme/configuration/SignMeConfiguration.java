package it.unical.demacs.asde.signme.configuration;
...
@ComponentScan(basePackages = { "it.unical.demacs.asde.signme" })
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager", basePackages = {
		"it.unical.demacs.asde.signme" })

public class SignMeConfiguration implements EnvironmentAware{
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(final EntityManagerFactoryBuilder builder) {
		return builder.dataSource(dataSource())//
				.packages("it.unical.demacs.asde.signme.model") //$NON-NLS-1$
				.persistenceUnit("signme") //$NON-NLS-1$
				.build();
	}
